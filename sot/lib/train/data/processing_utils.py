...
def sample_target(im, target_bb, search_area_factor, output_sz=None, return_crop_bbox=False):
    ...
    # Crop target
    crop_bbox = [x1, y1, crop_sz, crop_sz]
    ...
    if return_crop_bbox:
        return im_crop_padded, resize_factor, crop_bbox
