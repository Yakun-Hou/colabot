...
cfg.DATA.TRAIN.DATASETS_NAME = ["DEV"]
cfg.DATA.TRAIN.DATASETS_RATIO = [1, 1]
cfg.DATA.TRAIN.SAMPLE_PER_EPOCH = 60000
# DATA.VAL
cfg.DATA.VAL = edict()
cfg.DATA.VAL.DATASETS_NAME = ["DEV"]
...
# DATA.PRE_SEARCH
cfg.DATA.PRE_SEARCH = edict()
cfg.DATA.PRE_SEARCH.SIZE = 320
cfg.DATA.PRE_SEARCH.FACTOR = 5.0
cfg.DATA.PRE_SEARCH.CENTER_JITTER = 4.5
cfg.DATA.PRE_SEARCH.SCALE_JITTER = 0.5
cfg.DATA.PRE_SEARCH.NUMBER = 1
# DATA.TEMPLATE
