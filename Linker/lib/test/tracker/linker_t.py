...
from lib.models.ostrack import build_linker_t
...
class LinkerT(BaseTracker):
    def __init__(self, params, dataset_name):
        super().__init__(params)
        network = build_linker_t(params.cfg, training=False)
    ...
    def track(self, image, info: dict = None):
        ...
        with torch.no_grad():
            out_dict = self.network.forward(self.template, self.ps, search, ce_template_mask=self.box_mask_z)
