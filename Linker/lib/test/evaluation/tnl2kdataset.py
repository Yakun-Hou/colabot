...
class TNL2KDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        l_frames = os.listdir(frames_path)
        l_frames.sort()
        frames_list = [os.path.join(frames_path, frame_name) for frame_name in l_frames]
    ...
    def _get_sequence_list(self):
        sequence_list = [seq for seq in os.listdir(self.base_path) if os.path.isdir(os.path.join(self.base_path, seq))]
        sequence_list.sort()
