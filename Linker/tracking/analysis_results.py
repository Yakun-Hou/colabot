...
parser.add_argument('--tracker_name', default='ostrack_t')
...
trackers.extend(trackerlist(name=args.tracker_name, parameter_name=args.tracker_param, dataset_name=args.dataset_name,
                            run_ids=None, display_name='%s-%s' % (args.tracker_name, args.tracker_param)))
"""TransT"""
...
report_name = '%s-%s' % (args.tracker_name, args.tracker_param)
print_results(trackers, dataset, dataset_name, report_name=report_name,
              merge_results=True, plot_types=('success', 'prec', 'norm_prec'))
# print_per_sequence_results(trackers, dataset, dataset_name, report_name=report_name,
#                            merge_results=True, filter_criteria=None)
